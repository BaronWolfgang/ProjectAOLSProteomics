...
barplot(go_cluster2, showCategory = 10, title = "Top 10 GO Terms for Thalidomide Cluster 2")

# Plot the top 10 enriched GO terms for cluster 3
barplot(go_cluster3, showCategory = 10, title = "Top 10 GO Terms for Thalidomide Cluster 3")
...
```{}
cluster_gene_list <- list(
  thalomide_clust2_down = names(cluster_assignments[cluster_assignments == 1]),
  thalomide_clust3_up = names(cluster_assignments[cluster_assignments == 2])
)
